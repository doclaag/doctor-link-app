...
import { NavigationProp, useNavigation, useRoute, RouteProp, DrawerActions } from '@react-navigation/native';
...
type AppointmentTimeScreenRouteProp = RouteProp<RootStackParams, 'AppointmentTime'>;

export const AppointmentTimeScreen = () => {
  const navigation = useNavigation<NavigationProp<RootStackParams>>();
  const route = useRoute<AppointmentTimeScreenRouteProp>();
  ...
  return (
    <View style={globalStyles.centerContainerAppointmentTime}>
      <TitleShared
        label={'Nueva'}
        labelBold={'Cita'}
        subtitle={`Cita programada con el Dr. ${doctorName}`}
      />
